...
<div class="container-fluid">
   <ul class="nav nav-tabs">
     ...
     <li class="<?php if( $status == "inprogress"): echo "active"; endif; ?>"><a href="<?=site_url("admin/orders/1/inprogress")?>">Inprogress<span class="badge" style="background-color: #00bfff"><?=$inprogresscount?></span></a></li>
     ...
     <li class="<?php if( $status == "fail"): echo "active"; endif; ?>"><a href="<?=site_url("admin/orders/1/fail")?>">Failed <span class="badge" style="background-color: #8b3a3a"><?=$failCount?></span></a></li>
      <li class="pull-right custom-search">
         <form class="form-inline" action="<?=site_url("admin/apiorders")?>" method="get">
   ...
   <div class="row row-xs">
         ...
         <tr>
            ...
            <th class="dropdown-th">
              <div class="dropdown">
                <button class="btn btn-th btn-default dropdown-toggle" data-active="<?=$_GET["service_id"]?>" type="button" id="serviceList" data-href="admin/apiorders/counter" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Service
            ...
            <th width="10%" class="dropdown-th">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li class="<?php if( !$_GET["mode"] ): echo "active"; endif; ?>"><a href="<?=site_url("admin/apiorders/1/".$status)?>">Active</a></li>
                    <li class="<?php if( $_GET["mode"] == "manuel" ): echo "active"; endif; ?>"><a href="<?=site_url("admin/apiorders/1/".$status)?>?mode=manuel">Manual</a></li>
                    <li class="<?php if( $_GET["mode"] == "auto" ): echo "active"; endif; ?>"><a href="<?=site_url("admin/apiorders/1/".$status)?>?mode=auto">Auto</a></li>
                </ul>
              </div>
            </th>
            <th></th>
        ...
        <tbody>
          <?php foreach( $orders as $order ): ?>
              <tr>
                 ...
                 <td><?php if( $order["api_orderid"] != 0 ): echo '<div class="label label-api">Provider ID:-'.$order["service_api"].'</div>'; endif; ?><?php echo $order["service_name"]; ?></td>
