...
<div class="col-md-8">
  <div class="settings-header__table">
    <a href="<?php echo site_url("admin/appearance/language/new") ?>"  class="btn btn-default m-b">New language option</a>
  </div>
  <hr>
              ...
              <div class="dropdown pull-right">
                ...
                <ul class="dropdown-menu">
                  ...
                  <?php if( $language["default_language"] == 0 ): ?>
                    <li>
                      <a href="<?php echo site_url('admin/appearance/language/?lang-id='.$language["language_code"].'&lang-default=1') ?>">
