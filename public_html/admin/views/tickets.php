...
<div class="container-fluid">
   <ul class="nav nav-tabs">
      <li class="p-b"><button class="btn btn-primary dp-10" type="button" class="btn btn-default" data-toggle="modal" data-target="#modalDiv" data-action="new_ticket">New Ticket</button></li>
