...
void 0 !== e.options.paymobkiosk && t.initPaymobKiosk(e.options.paymobkiosk), void 0 !== e.options.paysky && t.initPaysky(e.options.paysky)), 
...
initPaysky: function(l) {
var d = this, s = l.configure, c = $("#method"), e = $("button[type=submit]", d.fieldsContainer), t = $("<button />", s).hide();
e.after(t), e.on("click", function(e) {
if (c.val() == l.type) {
e.stopImmediatePropagation();
var t = d.fieldsContainer.serializeArray();
t.push({
name: "save",
value: 1
});
var a = null, n = null, o = null, i = null, r = null;
return $.ajax({
...
method: "POST",
success: function(e) {
"success" == e.status && (a = e.data.secureHash, n = e.data.merchantReference, o = e.data.transactionDate, 
i = e.data.processingUrl, r = e.data.amount);
}
...
}, Lightbox.Checkout.showLightbox(), !1;
}
});
},
...
run: function() {
$("a[href^='/orders/'][href$='/refill']").on("click", function(e) {
e.preventDefault();
...
type: "GET",
success: function(e) {
"success" === e.status ? (t.empty(), t.text(e && e.btn_text || "")) : $(this).attr("disabled", !1);
},
error: function() {
$(this).attr("disabled", !1);
}
});
}), $("a[href^='/orders/'][href$='/cancel']").on("click", function(e) {
e.preventDefault();
var t = $(this).parents("td");
$(this).attr("disabled", !0);
e = $(this).attr("href");
