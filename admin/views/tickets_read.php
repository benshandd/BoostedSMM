...
<div class="container">
   <div class="row">
      ...
      <div class="col-md-12">
        <a href="admin/tickets"><i class="fa fa-backward" aria-hidden="true"></i>  <span>  Go Back</span></a> <?php if( $tickets["support_new"] == 2 ): ?><span>Last Message:-Unread</span>
<?php else: ?>
<span>Last Message:-Readed</span> <?php endif; ?>
<?php endforeach; ?>
         <div class="panel">
...
<div class="col-sm-6">
<div class="ticket-message__title-date">
<a  href="<?php echo site_url("admin/tickets/remove/".$ticketMessage[0]["id"]) ?>">Delete</a>
                                             </div>
</div>
